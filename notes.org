...
*** TODO *Channel List*: Users should be able to see a list of all current
...
- [ ] before login, several tags are not defined, maybe seperate each function by loading it
by its corresponding view

- [ ] the "create channel" form allows entering empty fields
